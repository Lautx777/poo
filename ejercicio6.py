#Herencia:
#Crear una clase base llamada Vehículo con atributos y métodos # comunes a todos los vehículos. 
# Luego, crear subclases como Coche y Moto que hereden de la clase Vehículo y tengan atributos
# y métodos específicos para cada tipo de vehículo.
